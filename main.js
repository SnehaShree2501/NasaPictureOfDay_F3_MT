let apikey = `zujJYsm5FIh6uFmtiNOZJ0aWP5gydSCbmqevMjhN`
...
let section = document.getElementById('header-image');
...
let inputDate = document.getElementById('form-input');
...
function addSearchToHistory(){
    ...
    let ul = document.getElementById('seach-data');
    ul.innerHTML = ''
    searches.forEach((item)=>{
